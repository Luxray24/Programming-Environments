...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
  ...
  <div class="magee-feature-box style1" id="" data-os-animation="fadeOut">
     '.$service_icon.'
    <h3 style="font-weight: bold; font-size: 64px">'.$title.'</h3>
    <div class="feature-content" style="font-weight: bold;">
     ...
     if( ($d+1) % 3 == 0){
		...
		?>
            <?php if( $section_title != '' ):?>
        <div class="section-title" style="font-size: 64px;"><?php echo do_shortcode($section_title);?></div>
        <?php endif;?>
